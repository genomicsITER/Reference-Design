...
my $gatk_queue = "/mnt/app_hdd/scratch/aprabh2/Broad_Ref_Pipeline/Queue_Broad_BestPractices/Queue.jar";
...
my $dbSNPvcf = '/mnt/app_hdd/scratch/aprabh2/Broad_Ref_Pipeline/Homo_sapiens_assembly19.dbsnp.vcf';
my $dbSNPindel = '/mnt/app_hdd/scratch/aprabh2/Broad_Ref_Pipeline/Homo_sapiens_assembly19.known_indels.vcf';
...
my $nfs_ExampleHaplotypeCaller = "/mnt/app_hdd/scratch/aprabh2/Broad_Ref_Pipeline/Queue_Broad_BestPractices/ExampleHaplotypeCaller.scala";y $queueDir = $tmpDir . "/.queue";
my $cwd = `cwd`;
print "$cwd\n";
...
my $readGroupHeader = "\@RG\\tID:$baseNameLane\\tLB:$baseName\\tSM:GENOME_TEST\\tPL:ILLUMINA";
...
Start_profiling($stage_tag);
print "$stage_tag\n";
run_and_log "java -Djava.io.tmpdir=$tmpDir -jar $gatk_queue -I $bamRealignFile -R $refgenomeFastaFile -D $dbSNPvcf -S $nfs_ExampleBaseRecalibrator -l DEBUG -run -jobRunner CMPShell" ;
system("rm -rf $queueDir; rm -r $jobReport; rm -rf $ExampleDir");
Stop_Profiling();
sleep(60);
