...
my $fqFile1, $fqFile2;
$fqFile1 = $inDataDir.$sample."_1.fq.gz";#".fastq.gz"; #"_1.fq";
$fqFile2 = $inDataDir.$sample."_2.fq.gz";#".fastq.gz"; #"_2.fq";
...
Start_profiling($stage_tag);
print "$stage_tag\n";
run_and_log "java -Djava.io.tmpdir=$tmpDir -jar $gatk_queue -R $refgenomeFastaFile -I $bamRealignFile -intervals $exome_targets_intervals -l DEBUG -S $nfs_ExampleHaplotypeCaller -run -jobRunner CMPShell";
Stop_Profiling();
system("rm -rf $queueDir; rm -r $jobReport; rm -rf $ExampleDir");
sleep(60);
