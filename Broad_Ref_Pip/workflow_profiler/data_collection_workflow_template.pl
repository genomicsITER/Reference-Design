...
my $interval = $ARGV[6];         # interval passed in from the global script. Default is 30s, or whatever the user specifies. 
...
my $stage_tag= TestRun; # a unique identifier for each stage
