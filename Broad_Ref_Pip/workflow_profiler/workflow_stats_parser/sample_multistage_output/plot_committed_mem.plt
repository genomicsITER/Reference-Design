...
set output "/home/jpinsonault/workflow_profiler_testing/workflow_stats_parser/_test_multi_stage/output_committed_mem_plot.png"
#set title "Total committed memory in gigabytes per phase sampled at 30 second intervals\n{/*0.7 sample\\_multistage\\_input}" font ",35"
...
plot "/home/jpinsonault/workflow_profiler_testing/workflow_stats_parser/_test_multi_stage/2014-05-02_15.27.30_active_mem.csv" using (t0(timecolumn(1))/3600):2 every ::3 ls 1 t "Stage1" with lines, \
