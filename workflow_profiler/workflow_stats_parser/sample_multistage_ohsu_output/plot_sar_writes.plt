...
set key outside bottom center box title "Pipeline phase" enhanced
set key maxrows 4
set key font ",25" spacing 1 samplen 2.9 width 2 height 1
set xlabel "Time (hours)" font ",25"
set ylabel "MBs/sec" font ",25"

set output "/mnt/app_hdd/aprabh2/WP_test/test1/sim1M_pairs_ohsu_16t_30s_2014-04-15_09-03-08/post_processed_stats/output_io_writes_per_sec.png"
...
plot "/mnt/app_hdd/aprabh2/WP_test/test1/sim1M_pairs_ohsu_16t_30s_2014-04-15_09-03-08/post_processed_stats/2014-04-15_09.41.06_sar_writes.csv" using (t0(timecolumn(1))/3600):2 every ::3 ls 1 t "bwa mem" with lines, \
