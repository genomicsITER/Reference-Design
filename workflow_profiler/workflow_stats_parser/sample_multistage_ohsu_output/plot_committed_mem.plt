...
set output "/mnt/app_hdd/aprabh2/WP_test/test1/sim1M_pairs_ohsu_16t_30s_2014-04-15_09-03-08/post_processed_stats/output_committed_mem_plot.png"
#set title "Total committed memory in gigabytes per phase sampled at 30 second intervals\n{/*0.7 sim1M\\_pairs\\_ohsu\\_16t\\_30s\\_2014-04-15\\_09-03-08}" font ",35"
...
plot "/mnt/app_hdd/aprabh2/WP_test/test1/sim1M_pairs_ohsu_16t_30s_2014-04-15_09-03-08/post_processed_stats/2014-04-15_09.41.07_active_mem.csv" using (t0(timecolumn(1))/3600):2 every ::3 ls 1 t "bwa mem" with lines, \
