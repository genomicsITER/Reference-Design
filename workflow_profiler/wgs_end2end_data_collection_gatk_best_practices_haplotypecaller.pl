...
my $broadDir = '/home/opt/data/Broad_Ref_Pipeline_approved_package/broad';
my $homosapiensrefgenomeDir = '/home/opt/data/Broad_Ref_Pipeline_approved_package/homosapiensrefgenome';
# TOOLS
...
my $finalBam = "/home/opt/data/broadout/Solexa-272221_gatk_best_practices_36t_30s_2015-11-11_12-57-04/Solexa-272221_final.bam";
...
Start_profiling($stage_tag);
print "$stage_tag\n";
run_and_log "java -Xmx8g -jar $gatk -T HaplotypeCaller -R $refgenomeFastaFile -I $finalBam -o $HCvcf -ERC GVCF --variant_index_type LINEAR --variant_index_parameter 128000 --pair_hmm_implementation LOGLESS_CACHING";
Stop_Profiling();
sleep(60);
