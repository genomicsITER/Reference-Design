...
$gatkBam1 = $inDataDir."FC1-NA12878-01_S1_L001_final.bam";
$gatkBam2 = $inDataDir."FC1-NA12878-01_S1_L002_final.bam";
...
print "$stage_tag\n";
run_and_log "java -Dsamjdk.try_use_intel_deflater=true -Xmx8g -jar $picard MarkDuplicates I=$gatkBam1 I=$gatkBam2 O=$bamDupRemFile M=$duplicateMetricsFile TMP_DIR=$tmpDir";
Stop_Profiling();
sleep(60);
...
Start_profiling($stage_tag);
print "$stage_tag\n";
run_and_log "java -Djava.io.tmpdir=$tmpDir -jar $gatk_queue -R $refgenomeFastaFile -I $bamRealignFile -intervals $exome_targets_intervals -l DEBUG -S $nfs_ExampleHaplotypeCaller -run -jobRunner CMPShell"; # -L $exome_targets_intervals";
Stop_Profiling();
sleep(60);
